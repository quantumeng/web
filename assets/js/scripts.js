...
const translations = {
    es: {
        ...
        home: {
            ...
            description: "Cheat external avanzado y spoofer para FiveM. Ideal tanto para jugar de forma legítima como para romper servidores. Stoppea el antichat, spawnea armas y más. Bypassea todos los anti-cheats y juega sin preocupaciones. Únete a nuestra comunidad en Discord.",
        ...
        showcase: {
            ...
            troll: {
                subtitle: "Video",
                title: "Troll",
                desc1: "Nuestro cheat es ideal tanto para jugar de forma legítima como para romper servidores. Funcionalidades avanzadas para una experiencia completa.",
                desc2: "Incluye funciones para stoppear el antichat, spawnear armas y muchas otras características avanzadas que te permiten control total del juego.",
                btn: "Ver Planes"
            }
        },
        products: {
        ...
        about: {
            ...
            title: "Quantum Engine",
            desc1: "Quantum Engine es una tienda especializada en cheats externos y spoofers para FiveM. Nuestros productos son ideales tanto para jugar de forma legítima como para romper servidores. Incluyen funciones avanzadas como stoppear el antichat, spawnear armas y muchas más. Ofrecemos las mejores soluciones para bypassear anti-cheats y eliminar bans, permitiéndote disfrutar de FiveM sin restricciones.",
    ...
    en: {
        ...
        home: {
            ...
            description: "Advanced external cheat and spoofer for FiveM. Ideal for both legitimate gameplay and breaking servers. Stop antichat, spawn weapons and more. Bypass all anti-cheats and play without worries. Join our Discord community.",
        ...
        showcase: {
            ...
            troll: {
                subtitle: "Video",
                title: "Troll",
                desc1: "Our cheat is ideal for both legitimate gameplay and breaking servers. Advanced features for a complete experience.",
                desc2: "Includes features to stop antichat, spawn weapons and many other advanced features that give you total control of the game.",
                btn: "View Plans"
            }
        },
        products: {
        ...
        about: {
            subtitle: "About Us",
            title: "Quantum Engine",
            desc1: "Quantum Engine is a store specialized in external cheats and spoofers for FiveM. Our products are ideal for both legitimate gameplay and breaking servers. They include advanced features such as stopping antichat, spawning weapons and many more. We offer the best solutions to bypass anti-cheats and remove bans, allowing you to enjoy FiveM without restrictions.",
    ...
    pt: {
        ...
        home: {
            ...
            description: "Cheat externo avançado e spoofer para FiveM. Ideal tanto para jogar de forma legítima quanto para quebrar servidores. Pare o antichat, spawne armas e muito mais. Bypassa todos os anti-cheats e jogue sem preocupações. Junte-se à nossa comunidade no Discord.",
        ...
        showcase: {
            ...
            troll: {
                subtitle: "Vídeo",
                title: "Troll",
                desc1: "Nosso cheat é ideal tanto para jogar de forma legítima quanto para quebrar servidores. Recursos avançados para uma experiência completa.",
                desc2: "Inclui recursos para parar o antichat, spawnar armas e muitas outras características avançadas que permitem controle total do jogo.",
                btn: "Ver Planos"
            }
        },
        products: {
        ...
        about: {
            subtitle: "Sobre Nós",
            title: "Quantum Engine",
            desc1: "Quantum Engine é uma loja especializada em cheats externos e spoofers para FiveM. Nossos produtos são ideais tanto para jogar de forma legítima quanto para quebrar servidores. Incluem recursos avançados como parar o antichat, spawnar armas e muitos outros. Oferecemos as melhores soluções para bypassar anti-cheats e remover bans, permitindo que você desfrute do FiveM sem restrições.",
